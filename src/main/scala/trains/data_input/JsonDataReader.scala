...
case class JsonDataReader[F[_]: Sync : ContextShift]()(implicit blocker: Blocker) extends DataReader[F] {

  override def readFile[G, A](path: String, decode: String => Either[io.circe.Error, G], convert: G => A): F[Either[ErrorMessage, A]] = {
